...
You can now go ahead and open the *redbag-push-latest.ipynb* notebook and run it. This will move the local model to an S3 bucket and be available for the TensorFlow Serving service to load and use in the Edge application set.
