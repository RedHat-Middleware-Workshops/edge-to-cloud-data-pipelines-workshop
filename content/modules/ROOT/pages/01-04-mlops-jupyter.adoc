...
NOTE: In this notebook the *Train Model* and *Compile augmented model* steps will take up to a couple minutes to complete, depending upon the lab class size and the cluster load at that time.
