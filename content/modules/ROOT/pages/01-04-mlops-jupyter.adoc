...
`edge-to-cloud-pipelines-workshop/workbench` _Double-click on the directories_
...
* You will notice as you step through this notebook that your loading a dataset of images stored in the github repository you cloaned.
...
* *You will need to replace 2 variables at the top of the file before you run it.*
...
You can also use the terminal window in your Jupyter environment to test out the Model Server which is running as part of your Edge application.  There will be much more discussion and work with the Model Server (TensorFlow in this case) as you move further through the labs.
...
In the AppDev module of this lab you will see how how various application services come together to build modern edge based applications infused with AI/ML capabilities.
...
[.bordershadow]
image::01-04/1-Jupyter-terminal.png[width=100%]
...
[.bordershadow]
image::01-04/3-Jupyter-terminal.png[width=100%]
...
[source,adoc]
[subs=attributes+]
MY_IMAGE=./samples/bali-tea.jpeg && \
MY_ROUTE=tf-server.svc:8501 && \
...
[subs=attributes+]
MY_IMAGE=./samples/bali-tea.jpeg && \
MY_ROUTE=tf-server.{user}-lab1-mlops.svc:8501 && \
