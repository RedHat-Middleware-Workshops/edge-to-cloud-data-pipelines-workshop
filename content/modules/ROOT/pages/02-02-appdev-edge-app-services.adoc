...
_There is an optional section at the end of the lab that takes you into the CamelK approach.  It uses DevSpaces and gives a deeper developer view of the possibilites of expanded use of application services and inner loop development on OpenShift._
